...
${HOME_DIR}/PDI-4.3/kitchen.sh -file=${HOME_DIR}/cure_etl/kettle/Process/Process.kjb -param:PROPERTIES=${HOME_DIR}/cure_etl/conf/PROCESS_XML.properties -level=Detailed -log=${HOME_DIR}/cure_etl/logs/process.log
